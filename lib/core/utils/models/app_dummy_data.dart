...
import '../../../features/shop/data/models/brand_category_model.dart';
import '../../../features/shop/data/models/brand_model.dart';
import '../../../features/shop/data/models/category_model.dart';
import '../../../features/shop/data/models/product_category_model.dart';
...
// Dummy data for ProductCategoryModel
  static const List<ProductCategoryModel> productCategories = [
    ...
    ProductCategoryModel(
      productId: '001',
      categoryId: '9', // Sport Shoes (subcategory of Sports)
    ),
    ProductCategoryModel(
      productId: '002',
      categoryId: '1', // Sports
...
// Dummy data for BrandCategoryModel
  static const List<BrandCategoryModel> brandCategories = [
    BrandCategoryModel(
      brandId: '1',
      categoryId: '1', // Sports
    ),
